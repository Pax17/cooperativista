Ext.define('Cooperativista.model.Student', {
    ...
    fields: [
        ...
        {
            name: 'studentOrderedName',
            calculate: function (data) {
                return `${data.name_3}, ${data.name} ${data.name_2}`.trim();
            }
        },
        {
            name: 'attribute_1'
        ...
        },
        {
            name: 'studentCourse',
            calculate: function (data) {
                return `${data.course_name}° ${data.course_name_2}`;
            }
        },
        {
            name: 'studentSearch',
            calculate: function (data) {
                return `${data.name} ${data.name_3} - ${data.course_name}° ${data.course_name_2}`;
            }
        }
    ],
    proxy: {
